  ...
  return (
    <div>
      <div className="flex flex-col font-poppins p-4">
        <div>
          <h1 className="text-2xl font-bold tracking-wide py-3 text-center">
            Log into QuickCart
          </h1>
        ...
        <form>
          ...
          <div className="flex py-5 gap-2 justify-between">
            <div className="flex gap-2">
              ...
              <button className="text-sm text-blue-500 hover:underline hover:text-blue-500 font-normal ease-in duration-200">
                Sign Up
              </button>
            </div>
            <div>
