...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  ...
  <div style="background-color: #f9f9f9; padding: 20px; border-radius: 0 0 5px 5px; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
    <p>Hello,</p>
    <p>Thank you for signing up Quick Cart! Your verification code is:</p>
...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  <div style="background: linear-gradient(to right, #2196F3, #1E88E5); padding: 20px; text-align: center;">
    <h1 style="color: white; margin: 0;">Welcome to our Quick Cart</h1>
  </div>
  <div style="background-color: #f9f9f9; padding: 20px; border-radius: 0 0 5px 5px; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
    <p>Hello,{name}</p>
    <p>Welcome to our website!</p>
    <div style="text-align: center; margin: 30px 0;">
      <span style="font-size: 24px; font-weight: bold; color: #2196F3;">We’re thrilled to have you here.</span>
    </div>
    <p>Thank you for joining us! Our site offers a variety of features and tools designed to provide you with the best experience. Feel free to explore and make the most out of everything we have to offer.</p>
